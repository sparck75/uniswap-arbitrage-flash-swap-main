...
module.exports.getPrices = async () => {
    const response = await request('https://api.coingecko.com/api/v3/simple/price?ids=sushi,frax-share,bittorrent,space,cake,axie-infinity,stellar,tron,bitcoin-cash,uniswap,fantom,dai,litecoin,binancecoin,ethereum,bitcoin,tether,usd-coin,busd,polkadot,shiba-inu,chainlink&vs_currencies=usd');
